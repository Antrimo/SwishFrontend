            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  ...
                  DOBBlock(blockColor: dob, textColor: dobText, digit: 'DD', height: 58, width: 68, controller: dayController),
                  DOBBlock(blockColor: dob, textColor: dobText, digit: 'MM', height: 58, width: 68, controller: monthController),
                  DOBBlock(blockColor: dob, textColor: dobText, digit: 'YYYY', height: 58, width: 92, controller: yearController),
                ],
              ), 
              const SizedBox(height: 20),
              Center(
              ...
              StackBlock(
                ...
                height: 58,
                width: 280,
                isFunction: true, isWidth: false,
              
              ),
              ElevatedButton(onPressed: Api().sendData, child: const Text('Send Data')),
            ]
        ),
      ),
    );
